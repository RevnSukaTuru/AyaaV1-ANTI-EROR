...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Helga Zex_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			helga.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6282138919347`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Helga Zex_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
⚠️ Segala kebijakan dan ketentuan AyaaBot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan AyaaBott-
😖🙏

For GitHub : https://github.com/AyaaChan
YouTube Helga : https://youtube.com/c/HelgaZexs妥
`
sendButLocation(from, `${menu}`, "*_©AyaaChan_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`ping`,buttonText:{displayText:'SPEED BOT'},type:1},{buttonId:`store`,buttonText:{displayText:'SEWABOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
⛾Rest Apii : https://apii-helgazex.herokuapp.com
...
_🌱え${prefix}ownermenu_
_🌱え${prefix}blmmenu_
_🌱え${prefix}groupmenu_
_🌱え${prefix}funmenu_
_🌱え${prefix}downloadmenu_
_🌱え${prefix}makermenu_
_🌱え${prefix}storagemenu_
_🌱え${prefix}toolsmenu_
_🌱え${prefix}wibumenu_
_🌱え${prefix}harammenu_
_🌱え${prefix}gamemenu_
_🌱え${prefix}othermenu_
`
sendButLocation(from, `${menu}`, "SINCE ©2020\n```CREATED BY AyaChan```", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`info`,buttonText:{displayText:'INFO RULES'},type:1},{buttonId:`store`,buttonText:{displayText:'SEWA BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
menu =` ${NamaBot}`
gbutsan = [
{buttonId:`allmenu`,buttonText:{displayText:'𝘼𝙇𝙇 𝙈𝙀𝙉𝙐⛈️'},type:1},
{buttonId:`store`,buttonText:{displayText:'𝙎𝙀𝙒𝘼 𝘽𝙊𝙏💤'},type:1},
{buttonId:`tos`,buttonText:{displayText:'𝙍𝙐𝙇𝙀𝙎🌨️'},type:1},
]
mhan = await helga.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
case 'waktu':
            ...
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6287705048235@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `©helga`, 'jpegThumbnail': fs.readFileSync('./heltod/helga.jpg')}}}})
            } else
if ((args[0]) == '2bulan'){
            pay =`${harga2bulan}`            
...
Owner: HELGA | wa.me/6282138919347`
...
*🦢› ׅ ࣪⊹ Kelebihan Bot ! ⊹ ۪ ּ*
*🐨 ִֶָ ࣪. Bot Menggunakan Rdp*
*🐨 ִֶָ ࣪. On 24 Jam*
*🐨 ִֶָ ࣪. Fast Respon*
...
*🐢 › SC NO PASARAN › 🐢*`
sendButLocation(from, `${menu}`, "_AyaaaChan🌸_", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'OKE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan AyaaBott-
😖🙏`
sendButLocation(from, `${menu}`, "_*© Helga Zex*_", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break*/
case 'verify':
...
_え ${prefix}spamsw_
_え ${prefix}upswteks_
_え ${prefix}upswlokasi_
_え ${prefix}upswaudio_
_え ${prefix}upswvoice_
_え ${prefix}upswsticker_
_え ${prefix}upswimage_
_え ${prefix}upswgif_
_え ${prefix}upswvideo_
_え ${prefix}shutdown_
_え ${prefix}offline_
_え ${prefix}online_
_え ${prefix}exif_
_え ${prefix}setprofile_
_え ${prefix}setname_
_え ${prefix}setprefix_
_え ${prefix}setbio_
_え ${prefix}leave_
_え ${prefix}restart_
_え ${prefix}addrespon_
_え ${prefix}delrespon_
...
_え ${prefix}unpin_
_え ${prefix}setmenu_
_え ${prefix}setallmenu_
_え ${prefix}leavetime_
_え ${prefix}bukatime_
...
_え ${prefix}hacked_
_え ${prefix}setnamegc_
_え ${prefix}setdeskgc_
...
case 'makermenu':
  if (!isRegistered) return reply(`daftar dlu om ketik .verify`)
     ...
     get_result = ini_result.result
       ...
       menu = `*MAKER MENU*
_え ${prefix}terbaikmaker_
_え ${prefix}bengekmaker_
_え ${prefix}memekertas_
_え ${prefix}shadow_
_え ${prefix}banner_
_え ${prefix}flaming_
_え ${prefix}rainbow_
...
_え ${prefix}listvn_
_え ${prefix}addsticker_
_え ${prefix}delsticker_
_え ${prefix}addvn_
_え ${prefix}delvn_
_え ${prefix}addimage_
_え ${prefix}delimage_        
...
case 'randombokep':
              ...
              helga.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftrol, caption: `NI BOKEP SAYA DAPAT DARI *©Helgaa* DOSA TANGGUNG SENDIRI🗿`})
              break
//Cecan
case 'cecan':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
mhan = await helga.prepareMessage(from, buff, image, {thumbnail: buff})
...
helga.sendMessage(from, buttonMessagessss, MessageType.buttonsMessage, {
        thumbnail: fs.readFileSync('./helga.jpg'),
        caption: 'Tes',
            quoted: mek})
break
//🐀💰 MALING
...
client.browserDescription = ['Helga Zex','Desktop','3.0']
...
let scen = await helga.sendMessage(from, fs.readFileSync(`./jadibot@${sender}.jpg`), MessageType.image, {quoted : mek,caption: 'Scan QR ini untuk jadi bot sementara!\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk WhatsApp Web\n3. Scan QR ini \n\nQR Expired dalam 20 detik'})    
setTimeout(() => {
       helga.deleteMessage(from, scen.key)
  }, 30000);
})  
...
break
            ...
            break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    helga.sendMessage(from, anu1, image, {quoted: mek, caption : `${prefix}sticker`})
                    break
				case 'semoji':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
Giliran = @${tty.player1.split('@')[0]}`
 helga.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     helga.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────『 *ALERT-ERROR*』─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer AyaaBott",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://wa.me/6282138919347"}}})
	}
    }
    }
    }
